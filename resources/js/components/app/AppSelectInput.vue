...
<template>
    ...
    >
        <div class="relative min-w-0 flex-1">
            ...
            <div
                v-if="isOpen"
                class="absolute top-[calc(100%+0.75rem)] left-0 z-50 w-max max-w-[min(22rem,calc(100vw-2rem))] min-w-full overflow-hidden rounded-[10px] border border-slate-200 bg-white p-1 text-slate-950 shadow-[0_24px_70px_-36px_rgba(15,23,42,0.9)]"
                role="listbox"
            >
                <button
