...
class BookingCreated implements ShouldDispatchAfterCommit, TriggersOutboundNotifications
{
    ...
    public function notificationContext(): array
    {
        return [
            ...
            'marketplace_listing_id' => $this->booking->marketplace_listing_id,
            'booking_mode' => $this->booking->booking_mode,
