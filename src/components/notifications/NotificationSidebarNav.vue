<template>
  <aside class="hidden lg:block">
    <div
      class="sticky top-5 overflow-hidden rounded-[20px] border border-slate-200 bg-white p-3 shadow-[0_16px_40px_-30px_rgba(16,32,51,0.45)] dark:border-slate-800 dark:bg-slate-900"
    >
      <RouterLink
        to="/home"
